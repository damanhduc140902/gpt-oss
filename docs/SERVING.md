...
sequences advance in lockstep at 64509 tokens per second on eight MI250 GCDs, and it is also the
...
| Measured throughput                                   | 64509 tok/s | 20168 tok/s |
| Implied token-step time                               | 185 ms      | 294 ms      |
