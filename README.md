...
The project attempts to achieve the given goals by optimizing the inference system deployed on a computing server system consisting of 8 AMD MI250 GPUs. Consequently, the inference system should be implemented using HIP programming model. 

Even though the goal is achieving the highest throughput, there are some restriction rules:
